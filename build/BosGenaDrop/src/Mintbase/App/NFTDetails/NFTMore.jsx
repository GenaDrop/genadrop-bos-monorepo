...
return(
    <div style={{marginBottom:"5rem",marginTop:"3rem"}}>
        ...
        <Bottom>
            <Card href="#" className="text-decoration-none">
                <Header>
                    <div className="header">
                        <div className="layout-image">
                            <div className="img">
                                <img className="image" src="https://image-cache-service-z3w7d7dnea-ew.a.run.app/thumbnail?url=https://arweave.net/4GlfSeiYPxLGywiZaSrzxfj8DsmXUhLPmIiuUf19lXc" alt="NFT" />
                            </div>
                        </div>
                    </div>
                </Header>
                <Container>
                    <div>
                        <small className="sub-text">pixel.mintbase1.near</small>
                        <div className="text">Pixel pals #479</div>
                    </div>
                    <div className="desc">
                        <div>
                        ...
                        <small className="text-s">Not Listed</small>
                    </div>
                </Container>
            </Card>
        ...
        <Footer>
            <button className="button">See Contract</button>
            <button className="button" style={{border:"none"}}>Explorer
                <svg
                    viewBox="0 0 512 512"
                    width={20}
                    height={20}
