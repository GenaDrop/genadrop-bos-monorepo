...
const hashData = (receipt_id) => fetch("https://api.nearblocks.io/v1/search?keyword=" +receipt_id);
return(
    <>
        <Provenance>
        ...
        <ContainerTable>
            ...
            <div>
                {dataTransaction&&dataTransaction.map((data,index)=>(
                    ...
                    <div className="time">
                        ...
                        {hashData(data.receipt_id).body.receipts[0]?.originated_from_transaction_hash && (
                            <a
                                href={
                                    "https://nearblocks.io/txns/" +hashData(data.receipt_id).body.receipts[0]?.originated_from_transaction_hash
                                }
                                target="_blank"
                                >
                                <svg
