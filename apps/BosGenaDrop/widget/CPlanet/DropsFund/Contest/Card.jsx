...
const handleVoteClick = () => {
  Near.call(
    props.isOnTestContract ? "fund-beta.genadrop.near" : "contest.genadrop.near",
    "vote",
    {
...
function handleCreateProposal() {
 Near.call([
    ...
    {
      contractName: props.isOnTestContract ? "fund-beta.genadrop.near" : "contest.genadrop.near",
...
const votedUsers = Near.view(props.isOnTestContract ? "fund-beta.genadrop.near" : "contest.genadrop.near", 'get_specific_art_voters', {
  contest_id: Number(props?.contestId),
  artist: props?.owner,
  subscribe: true
})
