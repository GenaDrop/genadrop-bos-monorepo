...
const MbRadioButton = styled.div`
  ...
  input[type='radio']:checked + label:before {
    border-color: ${isDarkModeOn ? '#A5B4FC' : '#93C5FD'}; /* border-blue-300 or border-blue-100 */
  }
  ...
  input[type='radio']:checked + label:after {
    ...
    background-color: ${isDarkModeOn ? '#A5B4FC' : '#93C5FD'}; /* bg-blue-300 or bg-blue-100 */
    cursor: pointer;
    top: 9px;
    left: 10px;
  }
  ...
  &disabled input[type='radio']:checked + label:before {
    border-color: ${isDarkModeOn ? '#374151' : '#E5E7EB'}; /* border-gray-150 or border-gray-800 */
    cursor: not-allowed;
  }

  &.disabled input[type='radio']:checked + label:after {
    border-color: ${isDarkModeOn ? '#374151' : '#E5E7EB'}; /* border-gray-150 or border-gray-800 */
    background-color: ${isDarkModeOn ? '#374151' : '#E5E7EB'}; /* bg-gray-150 or bg-gray-800 */
    cursor: not-allowed;
  }
