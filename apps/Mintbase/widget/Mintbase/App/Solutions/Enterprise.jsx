...
const HeroContainer =  styled.div`
    ...
    .btn-contract{
        ...
        :hover{
            --tw-bg-opacity:1;
            background-color:${isDarkModeOn ? "rgba(43,46,66,var(--tw-bg-opacity))":"#95949c"};
        }
    }
    .github{
        text-align:left;
...
const Stripe = styled.div`
    ...
    .btn-stripe{
        ...
        &:hover{
            --tw-bg-opacity: 1;
            background-color: ${isDarkModeOn ? "rgba(43,46,66,var(--tw-bg-opacity))" : "#efefef"};
        }
    }
    .btn-cus{
        background:white;
            ...
            <Hero>
                <HeroContainer>
                    <div className="hero-right">
                        ...
                        <button className="btn-contract"><a href="mailto:biz@mintbase.xyz" target="_blank" style={{textDecoration:"none",color:isDarkModeOn?"#ffffff":"#000000"}}>Contract us now</a></button>
                ...
                <div className="items">
                    {dataCard.map((value,index)=>(
                        <Card key={index}>
                            ...
                            <Footer>
                                <Button><a href={value.url} target="_blank" style={{textDecoration:"none",color:isDarkModeOn?"#ffffff":"#000000"}}>{value.button}</a></Button>
                            </Footer>
                        </Card>
                    ))}
                </div>
                ...
                <div className="layoutLeft">
                    ...
                    <div >
                        <button className="btn-see">
                            <a href="?page=solutions&tab=TopAffiliates" target="_blank" style={{textDecoration:"none",color:isDarkModeOn?"#1d1d1d":"#ffffff"}}>See How</a>
                        </button>
                    </div>
                </div>
