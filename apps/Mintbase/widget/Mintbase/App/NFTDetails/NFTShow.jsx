    ...
    <Container>
        <div className="layout">
            <div className="view-nft">
                <div className="layout-image">
                    ...
                    : <img className="nft" src={`https://image-cache-service-z3w7d7dnea-ew.a.run.app/media?url=https://arweave.net/${data.media}`} alt="nft"/>
                    }
                </div>
        ...
        <div className="custom-sale">
            <div className="right-container">
                ...
                </div>:<div className="mx-5 my-3 text-left">Not listed</div>}
            </div>
        </div>
    </Container>
)